...
<body>
	...
	<div style="margin-top: 0px;">
		<form method="post">
			...
			<div class="wrap">
				<div class="search">
					<input type="text" class="searchTerm" name="keyword" id="keyword"
						placeholder="Search" value="${keyword}"> <input
						type="submit" value="검색" class="searchButton" onClick="onSearch()" />
